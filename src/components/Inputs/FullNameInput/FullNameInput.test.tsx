...
describe("FullNameInput Tests", () => {
  ...
  it("When the component is render, then should have 1 textfield whit Correo Electrónico as placeholder", () => {
    ...
    expect(wrapper.find("label").at(0).text()).toEqual("Nombres y Apellidos");
  });

  it("When the text in component has change, then setFullName should be called", () => {
    act(() => {
      //@ts-ignore
